...
__all__ = ["smiles_to_graph_with_prompt", "smiles_to_prompt"]
...
def smiles_to_graph_with_prompt(smiles_lst, feats_1, feats_2, max_length=5, n_knowledge_nodes=3, n_global_nodes=1):
