...
class PolymDataset(Dataset):
    def __init__(self, dataset, split, root_path="../datasets"):
        ...
        fp_path_3 = os.path.join(root_path, f"{dataset}/maccs_ecfp_3.npz")
        md_path_3 = os.path.join(root_path, f"{dataset}/polymer_descriptors_3.npz")
    ...
    def __getitem__(self, idx):
        ...
        self.mds_1[idx], self.fps_2[idx], self.mds_2[idx], \
