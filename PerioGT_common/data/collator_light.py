...
from data.smiles2g_light import smiles_to_graph
    ...
    def __call__(self, samples):
        ...
        for i, smiles in enumerate(smiles_list):
            try:
                ...
                graphs.append(smiles_to_graph(aug_smiles, self.vocab, max_length=self.max_length, n_virtual_nodes=self.n_virtual_nodes, add_self_loop=self.add_self_loop))
            except:
                print(smiles)
