...
from data.smiles2g_graphgps import PolyGraphBuilderPretrain
...
class CollatorPretrain(object):
    def __init__(
            self,
            vocab,
            pos_enc_size, n_virtual_nodes, add_self_loop=True,
        ...
        self.builder = PolyGraphBuilderPretrain(self.vocab, self.pos_enc_size, self.n_virtual_nodes, self.add_self_loop)
