...
class PolymDatasetFF(Dataset):
    def __init__(self, root_path):
        ...
        md_path_1 = os.path.join(root_path, "polymer_descriptors_n3_norm.npz")
        md_path_2 = os.path.join(root_path, "polymer_descriptors_n6_norm.npz")
        md_path_3 = os.path.join(root_path, "polymer_descriptors_n9_norm.npz")
        self.smiles_list = pd.read_csv(smiles_path).smiles.values.tolist()
