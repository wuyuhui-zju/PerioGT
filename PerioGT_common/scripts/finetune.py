...
def finetune(args):
    ...
    train_dataset = PolymDataset(dataset=args.dataset, split='train', mode="finetune")
    val_dataset = PolymDataset(dataset=args.dataset, split='val', mode="finetune")
    test_dataset = PolymDataset(dataset=args.dataset, split='test', mode="finetune")
