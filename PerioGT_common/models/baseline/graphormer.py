...
from dgl.nn.pytorch import DegreeEncoder, PathEncoder, SpatialEncoder, GraphormerLayer
...
class Graphormer(nn.Module):
    def __init__(
        ...
        self.atom_encoder = nn.Linear(num_atom_features, embedding_dim)
    ...
    def forward(
        ...
        node_feat = self.atom_encoder(node_feat.float())
        ...
        # print(dist.size(), path_data.size())
